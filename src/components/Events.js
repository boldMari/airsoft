					...
					<div className="col">
						<div className="card shadow-sm">
							...
							<div className="card-body">
								...
								<p className="card-text">Naše burza je místem, kde můžete prodat své nepoužívané airsoftové vybavení a získat vybavení nové.</p>
							</div>
						</div>
					</div>
					<div className="col">
						<div className="card shadow-sm">
							...
							<div className="card-body">
								...
								<p className="card-text">Datum - první airsoftové hry v novém areálu.</p>
					...
					<div className="col">
						<div className="card shadow-sm">
							...
							<div className="card-body">
								...
								<p className="card-text">25.6.2023 - se konala poslední hra v areálu Klecan.</p>
								<div className="d-flex justify-content-between align-items-center">
									<div className="btn-group">
