			...
			<div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 py-5">
				...
				<div className="col d-flex align-items-start">
					...
					<div>
						...
						<p>(manuální/plynové/HPA pušky; 126m/s s kuličkami 0.25g) minimální vzdálenost pro střelbu je 𝟭𝟱 𝗺 a hráč je povinen mít záložní zbraň, splňující limit 1.7J.</p>
					</div>
				</div>
				<div className="col d-flex align-items-start">
					...
					<div>
						...
						<p>Povinnost si přinést vlastní zámek na regulátor, pokud jej nemají, nebudou vpuštěni do hry - <u>BEZ&nbsp;VÝJIMEK!</u></p>
					</div>
				</div>
				<div className="col d-flex align-items-start">
					...
					<div>
						...
						<p>Zásah granátem s obsahem kuliček je platný na vzdálenost o poloměru 3 m od místa iniciace a to jen u přímého zásahu.</p>
					</div>
				</div>
				<div className="col d-flex align-items-start">
					...
					<div>
						...
						<p>Používání gumových nožů, seker a jiných maket bodných nebo sečných zbraní je povoleno po schválení organizátorem, musí být bez ostrých hran a dostatečně měkčeny.</p>
					</div>
				</div>
				<div className="col d-flex align-items-start">
					...
					<div>
						...
						<p>Musí vážit alespoň 15 kg (výjimka pro hráče mladší 15 let - štít alespoň 3 kg), nesmí být průhledný (může mít průhledové okénko) a jeho plocha nesmí přesáhnout 9600 cm<sup>2</sup>.</p>
					</div>
				</div>
			</div>
