			...
			<div class="container">
				...
				<div class="row row-cols-1 row-cols-md-3 mb-3 text-center mt-5">
					...
					<div class="col">
						<div class="card mb-4 rounded-3 shadow-sm border-primary">
							<div class="card-header py-3 text-bg-primary border-primary">
								<h4 class="my-0 fw-normal text-shadow">Půldenní vstup</h4>
							</div>
							<div class="card-body">
					...
					<div class="col">
						<div class="card mb-4 rounded-3 shadow-sm border-primary">
							...
							<div class="card-body">
								<h1 class="card-title pricing-card-title">850 Kč<small class="text-body-secondary fw-light">/10 vstupů</small></h1>
								<ul class="list-unstyled mt-3 mb-4">
				...
				<h2 class="featurette-heading fw-normal lh-1 mt-4 pb-2 border-bottom text-primary">Půjčovna</h2>
				<div class="container">
						...
						<div class="col">
							<div class="card shadow-sm">
								<img src={g36} class="card-img-top cover" width="100%" height="250" alt="" role="img"
									focusable="false" />
								<div class="card-body">
									<p class="card-text">Půjčujeme G36c, co je airsoftová elektrická replika, která funguje na principu elektromotoru napájeného akumulátorem.</p>
